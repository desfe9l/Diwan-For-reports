...
export const BRAND = {
  owner: "فيصل العنزي",
  platform: "منصة تصميم التقارير",
  tagline: "تصميم التقارير والمستندات والتصاميم الرسمية",
  short: "فيصل العنزي",
  description:
    "أداة عمل شخصية لتصميم وإخراج التقارير والمستندات الرسمية: صفحات متعددة، أغلفة، جداول، مؤشرات، وتصدير PDF عالي الجودة بالعربية.",
} as const;
