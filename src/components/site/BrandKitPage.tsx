  ...
  return (
    <div className="min-h-full bg-paper dark:bg-[#111722]">
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
        ...
        <section className="py-10"><h2 className="text-[20px] font-extrabold">معلومات المنتج</h2><dl className="mt-5 grid gap-3 sm:grid-cols-3"><Fact label="اسم المنتج" value="نسق" /><Fact label="المصمم والمطور" value="فيصل المضياني" /><Fact label="نوع المنتج" value="منصة تصميم وتحرير عربية" /></dl></section>
