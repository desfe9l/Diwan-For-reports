 ...
 * the studio's own visual language (navy paper, gold rule, report cover) using
...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  body{width:1200px;height:630px;font-family:Cairo,system-ui,sans-serif;background:#071d3d;overflow:hidden;position:relative}
  ...
  .eyebrow{display:inline-flex;align-items:center;gap:12px;color:#e8c978;font-weight:800;font-size:19px;letter-spacing:.5px}
  .eyebrow i{display:block;width:44px;height:3px;background:#e8c978;border-radius:2px}
  ...
  .band{height:74px;background:#0d2a52}
  .rule{height:5px;background:#c6a05a}
  .pad{padding:26px 28px}
  .ln{height:13px;border-radius:3px;background:#0d2a521f;margin-bottom:13px}
  .ln.s{width:48%}
  .ln.m{width:72%}
  .statrow{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:22px}
  .stat{border:1px solid #0d2a5220;border-radius:5px;padding:14px 12px}
  .stat b{display:block;color:#0d2a52;font-size:26px;font-weight:900}
  .stat span{display:block;color:#5d6b80;font-size:12px;font-family:Tajawal,sans-serif;margin-top:4px}
  .bars{margin-top:20px}
  .bar{height:11px;border-radius:4px;background:#0d2a5214;margin-bottom:10px;overflow:hidden}
  .bar i{display:block;height:100%;background:#c6a05a}
  .seal{position:absolute;left:26px;bottom:24px;width:74px;height:74px;border-radius:50%;border:3px solid #c6a05a55;display:grid;place-items:center;color:#c6a05a;font-size:11px;font-weight:800;text-align:center;line-height:1.3;font-family:Tajawal,sans-serif}
  .who{position:absolute;right:72px;bottom:44px;display:flex;align-items:center;gap:14px;color:#fff}
  .who .mark{width:46px;height:46px;border-radius:10px;background:#122b4d;border:1px solid #ffffff26;display:grid;place-items:center}
...
<div class="wrap">
  <div>
    <div class="eyebrow"><i></i> منصة تصميم التقارير</div>
    <h1>صمّم تقاريرك<br>باحتراف</h1>
    <p>محرر عربي بمقاسات A4 وA3 وشرائح 16:9 — نصوص وجداول وصور ومؤشرات، مع تصدير PDF عالي الجودة.</p>
    <div class="tags">
...
<div class="who">
  <span class="mark"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="4.5" y="2.6" width="13.4" height="18.8" rx="1.7" stroke="#e8c978" stroke-width="1.7"/><path d="M8 8.4h6.4M8 12.4h6.4M8 16.4h3.6" stroke="#e8c978" stroke-width="1.7" stroke-linecap="round"/></svg></span>
  <span><b>فيصل العنزي</b><span>تصميم التقارير والمستندات الرسمية</span></span>
</div>
</body></html>`;

const icon = `<!DOCTYPE html><html><head><meta charset="utf-8"><style>
  *{margin:0;padding:0}
  body{width:180px;height:180px;background:#071d3d;display:grid;place-items:center}
  svg{display:block}
</style></head><body>
  <svg width="132" height="132" viewBox="0 0 32 32" fill="none">
    <rect x="7.4" y="4" width="17.2" height="24" rx="2.2" stroke="#e8c978" stroke-width="1.9"/>
    <path d="M11.6 12.2h8.8M11.6 16.6h8.8M11.6 21h5" stroke="#e8c978" stroke-width="1.9" stroke-linecap="round"/>
    <path d="M20.6 4v5.6h4" stroke="#c6a05a" stroke-width="1.6" stroke-linejoin="round"/>
  </svg>
</body></html>`;
...
const favicon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <rect width="32" height="32" rx="7" fill="#071d3d"/>
  <rect x="7.4" y="4.6" width="17.2" height="23" rx="2" fill="none" stroke="#e8c978" stroke-width="1.9"/>
  <path d="M11.6 12.6h8.8M11.6 16.8h8.8M11.6 21h5" stroke="#e8c978" stroke-width="1.9" stroke-linecap="round"/>
  <path d="M20.6 4.6v5.4h4" stroke="#c6a05a" stroke-width="1.7" stroke-linejoin="round"/>
</svg>`;
